...
use Symfony\Component\Security\Csrf\EventListener\ClearSameOriginCsrfTokenListener;
...
return static function (ContainerConfigurator $container) {
    $container->services()
        ...
        ->set('security.csrf.listener.clear_same_origin_token', ClearSameOriginCsrfTokenListener::class)
            ->args([
                abstract_arg('framework.csrf_protection.cookie_name'),
            ])
